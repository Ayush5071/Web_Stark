    ...
    return (
        <div className="p-8 bg-gray-900 text-white min-h-screen">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {myAds.map(ad => (
                    <div key={ad._id} className="relative p-6 bg-gray-800 rounded-lg shadow-lg hover:shadow-xl transition-shadow">
                        ...
                        <p className="text-lg font-semibold">Price: ₹{ad.price}</p>
