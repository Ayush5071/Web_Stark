...
function Login() {
  ...
  return (
    ...
    >
      <div className="relative z-10 p-10 bg-white/70 backdrop-blur-md rounded-xl shadow-lg w-96 max-w-lg">
        <h2 className="text-2xl font-semibold text-black text-center mb-4">
          Login
        </h2>
        {error && <p className="text-blue-800 text-center mb-4">{error}</p>}
        <form onSubmit={handleLogin}>
          ...
          <button
            type="submit"
            className="w-full p-3 rounded-lg bg-blue-700 text-white font-semibold hover:bg-blue-900 transition"
          >
            Login
          </button>
        </form>
